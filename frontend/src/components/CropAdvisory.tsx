            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8">
                ...
                {activeTab === "detailed" && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 dark:text-dark-300 transition-colors duration-200">
                            Advanced crop analysis and recommendations coming
                            soon
                        </p>
                    </div>
                )}
                {activeTab === "analytics" && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 dark:text-dark-300 transition-colors duration-200">
                            Performance insights and data visualization coming
                            soon
                        </p>
                    </div>
                )}
                {activeTab === "history" && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 dark:text-dark-300 transition-colors duration-200">
                            Past recommendations and progress tracking coming
                            soon
                        </p>
                    </div>
                )}
