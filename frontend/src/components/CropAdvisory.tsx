...
const CropAdvisory: React.FC = () => {
    ...
    const generateFasalCalendar = (cropName: string): FasalCalendar => {
        const baseActivities: CalendarActivity[] = [
            ...
            },
            {
                ...
                description:
                    "Apply nitrogen-rich fertilizer for initial growth boost",
                icon: "🧪",
                type: "fertilizer",
                budget: "₹2,000-3,500",
                completed: false,
            ...
            },
            {
                ...
                description:
                    "Regular inspection for early signs of pests and diseases",
                icon: "🐛",
                type: "pest",
                budget: "₹1,000-1,500",
                completed: false,
        ...
        const progressPercentage =
            (completedCount / baseActivities.length) * 100;
                ...
                <div className="bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700 rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm transition-colors duration-200">
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                        ...
                        <div className="flex space-x-1 sm:space-x-2">
                            <button
                                ...
                                className={`px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium flex items-center space-x-1 sm:space-x-2 transition-colors duration-200 ${showFilters
                    ...
                    <div className="mt-6 flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/30 rounded-lg border border-green-200 dark:border-green-700 transition-colors duration-200">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${farmInput.organicPreference
                                ? "bg-green-600 dark:bg-green-500"
                                : "bg-gray-200 dark:bg-dark-600"
                                }`}
                        >
                            <span
                                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${farmInput.organicPreference
                                    ? "translate-x-6"
                                    : "translate-x-1"
                                    }`}
                            />
                    ...
                    <div className="space-y-4 sm:space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex space-x-2">
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 ${compareMode
                                        ? "bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-700"
                                        : "bg-gray-100 dark:bg-dark-700 text-gray-700 dark:text-dark-200 hover:bg-gray-200 dark:hover:bg-dark-600"
                                        }`}
                                >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                            {recommendations.map((crop, index) => (
                                <div
                                    key={index}
                                    className={`relative bg-white dark:bg-dark-800 border-2 rounded-xl p-6 hover:shadow-lg transition-all duration-200 transform hover:scale-105 ${compareMode &&
                                    ...
                                    {crop.marketPrice && (
                                        <div className="mb-4 p-3 bg-gray-50 dark:bg-dark-900 rounded-lg transition-colors duration-200">
                                            ...
                                            <div className="text-xs text-gray-600 dark:text-dark-300">
                                                Demand:{" "}
                                                <span
                                                    className={`font-medium ${crop.demandTrend ===
                                                        "High"
                                                        ? "text-green-600"
                                                        : crop.demandTrend ===
                                                            "Medium"
    ...
    const FasalCalendarTab = useCallback(
        () => (
                ...
                {calendarData ? (
                    <>
                        <div className="bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700 rounded-xl p-6 shadow-sm transition-colors duration-200">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-dark-300 mt-1 transition-colors duration-200">
                                        AI-powered seasonal activity plan for{" "}
                                        {calendarData.season}
                                    </p>
                                </div>
                                <div className="text-right">
                                    <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                                        {Math.round(
                                            calendarData.progressPercentage,
                                        )}
                                        %
                                    </div>
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <span className="text-sm text-gray-600 dark:text-dark-300 transition-colors duration-200">
                                        {
                                            calendarData.activities.filter(
                                                (a) => a.completed,
                                            ).length
                                        }{" "}
                                        of {calendarData.activities.length}{" "}
                                        tasks
                                    </span>
                                </div>
                                <div className="w-full bg-gray-200 dark:bg-dark-700 rounded-full h-3 transition-colors duration-200">
                                    <div
                                        ...
                                        style={{
                                            width: `${calendarData.progressPercentage}%`,
                                        }}
                                    ></div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                                ...
                                <div className="bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-700 rounded-lg p-4 transition-colors duration-200">
                                    <div className="flex items-center">
                                        <Bell
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-bold text-purple-900 dark:text-purple-200">
                                                {calendarData.activities.length}{" "}
                                                planned
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-orange-50 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-700 rounded-lg p-4 transition-colors duration-200">
                                    <div className="flex items-center">
                                        <AlertCircle
                        ...
                        {calendarData.weatherAlerts.length > 0 && (
                            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/30 dark:to-orange-900/30 border border-yellow-200 dark:border-yellow-700 rounded-xl p-6 transition-colors duration-200">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            {calendarData.weatherAlerts.map(
                                                (alert, index) => (
                                                    <div
                                                        key={index}
                                                        className="flex items-start space-x-2"
                                                    >
                                                        <span className="w-2 h-2 bg-yellow-500 dark:bg-yellow-400 rounded-full mt-2 flex-shrink-0"></span>
                        ...
                        <div className="bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700 rounded-xl p-6 shadow-sm transition-colors duration-200">
                            ...
                            <div className="space-y-4">
                                {calendarData.activities.map(
                                    (activity, index) => (
                                        <div
                                            key={activity.id}
                                            className={`relative border-2 rounded-xl p-6 transition-all duration-200 ${activity.completed
                                        ...
                                        >
                                            ...
                                            <div className="absolute -top-3 left-6">
                                                <span
                                                    className={`px-3 py-1 rounded-full text-xs font-bold ${activity.completed
                                            ...
                                            <div className="flex items-start justify-between pt-3">
                                                <div className="flex items-start space-x-4 flex-1">
                                                    <button
                                                        ...
                                                        className={`mt-1 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${activity.completed
                                                    ...
                                                    <div className="flex-1">
                                                        <div className="flex items-center space-x-3 mb-3">
                                                            ...
                                                            <div>
                                                                <h4
                                                                    className={`font-bold text-lg ${activity.completed
                                                                ...
                                                                <div className="flex items-center space-x-2 mt-1">
                                                                    <span
                                                                        className={`px-2 py-1 rounded-full text-xs font-medium ${activity.type ===
                                                                            "sowing"
                                                                    ...
                                                                    <span
                                                                        className={`px-2 py-1 rounded-full text-xs font-medium ${activity.priority ===
                                                                            "High"
                                                                            ? "bg-red-100 text-red-800"
                                                                            : activity.priority ===
                                                                                "Medium"
                                                        ...
                                                        {activity.alternatives &&
                                                            activity
                                                                .alternatives
                                                                .length > 0 && (
                                                                <div className="mt-4 p-4 bg-gray-50 dark:bg-dark-700 rounded-lg border border-gray-200 dark:border-dark-600 transition-colors duration-200">
                                                                    <p className="text-sm font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center">
                                                                        <Lightbulb
                                                                            className="mr-2 text-yellow-600 dark:text-yellow-400"
                                                                            size={
                                                                                16
                                                                    ...
                                                                    <ul className="space-y-2">
                                                                        {activity.alternatives.map(
                                                                            (
                                                                                ...
                                                                                >
                                                                                    <span className="w-1.5 h-1.5 bg-yellow-500 dark:bg-yellow-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                                                ...
                                                <div className="flex space-x-2">
                                                    <button className="p-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 border border-gray-300 dark:border-dark-600 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors duration-200">
                                                        <Camera size={16} />
                                                    </button>
                                                    <button className="p-2 text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 border border-gray-300 dark:border-dark-600 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors duration-200">
                                                        <Bell size={16} />
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        {/* Integration Notice */}
                        <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/30 dark:to-blue-900/30 border border-green-200 dark:border-green-700 rounded-xl p-6 transition-colors duration-200">
                            <div className="flex items-start">
                                <Leaf
                                    className="text-green-600 dark:text-green-400 mr-3 mt-1"
                                    size={20}
                                />
                                <div>
                                    ...
                                    <p className="text-green-700 dark:text-green-200 leading-relaxed">
                                        Each completed task is automatically
                                        logged into your Farm Health Report.
                                        Track your farming progress, maintain
                                        detailed records, and get insights for
                                        better decision making. Your data helps
                                    ...
                                    <div className="mt-3 flex space-x-3">
                                        ...
                                        <button className="px-4 py-2 border border-green-600 dark:border-green-500 text-green-700 dark:text-green-300 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/30 text-sm font-medium transition-colors duration-200">
                                            Download Report
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6">
                            Generate crop recommendations first to view the
                            fasal calendar
                        </p>
                        <button
                            onClick={() => setActiveTab("quick")}
                            className="px-6 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors duration-200"
                        >
                            Get Recommendations
                        </button>
                    </div>
        ...
        [calendarData, setCalendarData, setActiveTab],
    );
                        ...
                        {tabs.map((tab) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center space-x-2 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 ${isActive
